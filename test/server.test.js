...
test('migrations apply once and are idempotent', () => {
  ...
  assert.deepEqual(migrate(d), ['001-init.sql', '002-checkin.sql', '003-review.sql', '004-conflicts.sql', '005-frontier.sql', '006-service.sql', '007-verification.sql', '008-girl-merge.sql', '009-star-legacy-mode.sql']);
